...
==3460602==ERROR: AddressSanitizer: requested allocation size 0xffffffffd4a51000 (0xffffffffd4a52000 after adjustments for alignment, red zones etc.) exceeds maximum supported size of 0x10000000000 (thread T0)\n
    ...
    #1 0x561e08193e0f in exit /home/user/sanitize/size-too-big.cpp:11:25\n
    #2 0x561e08193e0f in ignored_func_name /home/user/sanitize/size-too-big.cpp:12:25\n
    #3 0x561e08193e0f in not_ignored_func_name /custom/ignored/file/path/size-too-big.cpp:13:25\n
    #4 0x561e08193e0f in bad /usr/include/c++/../../../home/user/sanitize/size-too-big.cpp:14:25\n
    #5 0x561e08193e4a in main /home/user/sanitize/size-too-big.cpp:16:5\n
    #6 0x7f0f079cb082 in __libc_start_main
